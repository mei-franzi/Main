...
project="test" # $1 # Call script using project name as the only argument
# Specify the directory for the output
OUTPUT_DIR="/data/fm346/ngs/reprogramming/Gill-trans/${project}/data/output/"
# Specify location of input fastq files. 
# this directory contains 3 fastq.gz files 
RAW_SAMPLE_DIR="/data/fm346/ngs/reprogramming/Gill-trans/${project}/data/fastq/"
SUFFIX_INPUTFILES='.fastq.gz'
SEQTYPE="RNASeq"
SEQMODE="single" #specify "paired" or "single" end mode

# Choose the main organism for genome alignment
# {NOTE: This is a label-specific ID that can contain any text to identify which genome version was used}.
ORGANISM_GENOME_ID="h38.p14"
# PATH/Directory in which the genome files are located
# the files are softlinked from /data/fm346/ngs/databases/human
# to /data/fm346/ngs/reprogramming/Gill-trans/test/databases
GENOME_FILES_DIR="/data/fm346/ngs/reprogramming/Gill-trans/test/databases"
